...
function InfoCard({
  ...
  const base = `
    flex items-start gap-4 p-5 rounded-xs bg-white
  ...
  const content = (
    <>
      <div className="w-11 h-11 rounded-xs bg-[var(--color-primary-light)]/40 flex items-center justify-center shrink-0">
...
export default function Contact() {
  ...
  return (
    ...
    <>
                    ...
                    <ul className="space-y-2 mt-0.5">
                      {schedules.map((s, i) => (
                        <li key={i} className="flex flex-col gap-0.5">
                          ...
                          <span
                            className="text-xs font-medium px-2 py-0.5 rounded-xs inline-block w-fit"
      ...
      {/* ══ MAPA ══ */}
      {store?.address && (
        <section className="relative bg-transparent px-4 sm:px-6 lg:px-8 pb-0">
          <div className="max-w-7xl mx-auto">
            <div
              className="rounded-xs overflow-hidden border border-[var(--color-border)]"
      ...
      {whatsappNumber && (
        <>
          <div className="bg-transparent overflow-hidden leading-none" aria-hidden="true">
            <svg
              viewBox="0 0 1440 64"
