...
const inputClass = `
  w-full px-4 py-3.5 rounded-xs text-sm
...
export function ContactForm() {
  ...
  if (status === "success") {
    return (
      <div className="rounded-xs border border-[var(--color-border)] bg-white p-10 text-center relative overflow-hidden">
        {/* Pata de fondo */}
        <svg
          viewBox="0 0 60 80"
  ...
  /* ── Formulario ── */
  return (
    <div className="rounded-xs border border-[var(--color-border)] bg-white p-6 sm:p-8">
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        {status === "error" && (
          <div
            className="flex items-center gap-3 p-4 rounded-xs
